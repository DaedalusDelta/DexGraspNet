...
if __name__ == '__main__':
    ...
    joint_names = ['index_mcpf', 'index_mcps', 'index_pip', 'index_dip', 'middle_mcpf', 'middle_mcps', 'middle_pip', 'middle_dip', 'ring_mcpf', 'ring_mcps', 'ring_pip', 'ring_dip', 'pinky_mcpf', 'pinky_mcps', 'pinky_pip', 'pinky_dip', 'palm_4_finger', 'palm_thumb', 'thumb_mcpf', 'thumb_mcps', 'thumb_ip']
    ...
    if not args.no_force:
        ...
        hand_model = HandModel(
            mjcf_path='./leap_aligned_fingers_2_simplified/mjmodel.xml',
            mesh_path='./leap_aligned_fingers_2_simplified',
            contact_points_path='./leap_aligned_fingers_2_simplified/contact_points.json',
            penetration_points_path='./leap_aligned_fingers_2_simplified/penetration_points.json',
            device=device
        )
